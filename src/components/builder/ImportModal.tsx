      ...
      <div className="bg-white rounded-xl shadow-2xl w-[95vw] max-w-6xl h-[85vh] flex flex-col">
        ...
        <div className="px-4 pt-3">
          <div className="flex items-center justify-between text-sm">
            ...
            {tab === 'validate' && !!spec && !error && (
              <button className="btn-base btn-primary btn-md" onClick={createForm}>Create Form</button>
            )}
          </div>
        </div>
          ...
          {tab === 'paste' && (
            <div className="h-full overflow-auto grid md:grid-cols-2 gap-4">
              <div>
                ...
                <LineNumberedTextarea className="h-[50vh]" value={raw} onChange={(e)=>setRaw(e.target.value)} />
            ...
            <div className="h-full overflow-auto space-y-3">
              {error ? (
                ...
                <>
                  ...
                  {/* Actions moved to top bar on Validate tab */}
                </>
              )}
            </div>
          )}
